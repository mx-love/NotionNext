...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '漫雪', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '见千山雪白头，坐一空山镜月', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://mx.020627.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '梦雪, 博客', // 网站关键词 英文逗号隔开
